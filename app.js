...
function sendNotif(msg) {
     slack.send({
          ...
          channel: getChannel,
          username: 'UHBot',
          attachments: [{"pretext": "*Nouveau bug signalé :*", "text": "Joueur1 peut tuer Joueur2 \r\n ", "color":"#F35A00", "fields": [{"title": "Signalé par:", "value": "'" + user + "'", "short": "false"}, {"title": "Priorité:", "value": "Indéterminé", "short": "false"}]}],
